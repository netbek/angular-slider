...
angular.module('ui.slider.templates', ['ui.slider.html']);

angular.module("ui.slider.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("ui.slider.html",
